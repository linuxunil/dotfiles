    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          -- NOTE: All LSP keybindings have been moved to which-key.lua
      ...
      local servers = {
        ...
        --     },
        --   },
        --   -- Disable pyright's formatting and other capabilities
        ...
        basedpyright = {
          settings = {
            basedpyright = {
              -- Disable linting (let ruff handle it)
          ...
          -- Disable formatting and other capabilities
          capabilities = (function()
            local caps = vim.tbl_deep_extend('force', {}, capabilities)
            caps.textDocument.formatting = false
            caps.textDocument.rangeFormatting = false
            caps.textDocument.codeAction = false
            return caps
          end)(),
        },
